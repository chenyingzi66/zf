// pages/tenant/register/register.js
const app = getApp();
const { tenantRegister, sendTenantSms } = require('../../../utils/api.js');
...
Page({
  ...
  register() {
    ...
    tenantRegister(this.data.phone, this.data.password, this.data.code)
      .then(result => {
        console.log('租客注册结果:', result);
