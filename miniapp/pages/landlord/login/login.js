// pages/landlord/login/login.js
const app = getApp();
const { landlordLogin } = require('../../../utils/api.js');
...
Page({
  ...
  login() {
    ...
    landlordLogin(this.data.phone, this.data.password)
      .then(result => {
        ...
        if (result.code === 200 && result.data) {
          ...
          console.log('保存的token:', result.data.token);
          console.log('保存的userInfo:', result.data);
  ...
  goRegister() {
    wx.navigateTo({ url: '/pages/landlord/register/register' });
  }
});
